...
namespace berkeley_college.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AddressId,Country,City,PostalCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AddressId,Country,City,PostalCode")] Address address)
        {
